...
Những khách hàng mua tối thiểu 20.000 giấy phép cho đối tượng thuê Exchange Online sẽ đủ điều kiện sử dụng các dịch vụ bổ sung của Trung tâm FastTrack. Xem Tính [đủ điều kiện để](eligibility.md) biết thêm chi tiết. 
...
Ví Skype for Business Online, chúng tôi cung cấp hướng dẫn về việc di chuyển người dùng Lync Skype for Business cơ sở sang Skype for Business Online.
  
## <a name="microsoft-365-apps"></a>Ứng dụng Microsoft 365

Ví dụ Ứng dụng Microsoft 365, chúng tôi cung cấp hướng dẫn như sau: 
...
- Phát triển cấu hình triển khai và cập nhật thiết đặt bằng cách sử Office 365 Cụ Triển khai Office Công cụ Tùy chỉnh. 
- Deployment packaging using the Microsoft Endpoint Configuration Manager.  
- Cho phép sử dụng Bộ công cụ Sẵn sàng cho Office để xác định các vấn đề tiềm tàng về tính tương thích với macro và phần bổ trợ Microsoft Visual Basic for Applications (VBA) mà bạn sử dụng với các Office.
    
## <a name="fasttrack-responsibilities"></a>Trách nhiệm của FastTrack

Các Chuyên gia FastTrack có trách nhiệm sau đây trong quá trình triển năng. Những điều này có thể bổ sung hoặc thay thế các hoạt động được xác định trong [Quy trình và Kỳ vọng](process-and-expectations.md).
...
- Cung cấp thiết kế kiến trúc tham chiếu chuẩn cho một cấu trúc AD FS dư thừa địa lý kéo dài hai (2) trung tâm dữ liệu. Kiến trúc tiêu chuẩn cung cấp cho:
  - Xác thực được liên kết cho các dịch vụ trong phạm vi Lợi ích Trung tâm FastTrack. 
  - Phục hồi site đơn.  
...
- Xem lại các chính sách và cấu hình cần thiết để bảo mật Office 365 nguyên khác.  
...
- Xác thực chức năng xác thực liên kết với chính sách truy nhập máy khách đã sửa đổi cho các kịch bản truy nhập được xác định với cấu hình lên đến 10 người dùng.
...
- Cung cấp hướng dẫn về cấu hình môi trường Lync Skype for Business cơ sở để bật UM và hướng dẫn cụ thể:  
  - Exchange Online chính sách được lưu trữ riêng tư.  
  - Exchange Online sách thư thoại được lưu trữ riêng tư. 
...
- Cung cấp hướng dẫn về cùng tồn tại của cây thư mục công cộng đơn lẻ, bao gồm:  
  ...
  - Exchange Online để chuyển hướng truy nhập thư mục công cộng vào các thư mục công cộng tại chỗ.  
...
- Cung cấp mẫu hướng dẫn cho:  
  ...
  - Các ứng dụng sử Exchange hộp thư.  
  - Các ứng dụng yêu cầu cài đặt các cấu phần của bên thứ ba hoặc tùy chỉnh trên Exchange chủ.
...
- Cung cấp hướng dẫn về cách tạo kế hoạch di chuyển, bao gồm:  
  ...
  - Phối hợp kích cỡ lô di chuyển, mức lỗi và hỗ trợ bộ trợ giúp dự kiến. 
...
- Thực hiện hành động kịp thời để giảm thiểu các rủi ro và giải quyết các vấn đề do khách hàng, người quản lý dự án đối tác nêu ra và Người quản lý FastTrack.   
