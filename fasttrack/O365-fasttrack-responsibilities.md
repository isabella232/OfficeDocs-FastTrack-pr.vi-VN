...
- Thử nghiệm tính năng SSO liền mạch nếu được triển khai.
- Lái xe nhận con nuôi và giá trị dịch vụ thành công.
...
- Đặt cấu hình Exchange Online Protection, bảo vệ mất dữ liệu (các) và mã hóa thông điệp Office 365 (OME) và Office 365 Advanced Threat Protection (ATP) (nếu sẵn dùng trong gói đăng ký của bạn) và xác minh các bản ghi MX của bạn đến Office 365 cho tất cả các tên miền được hỗ trợ thư.
...
- Cấu hình tự động hóa, điều tra và phản hồi cho Office 365 ATP (nếu sẵn dùng trong gói đăng ký của bạn).
    
Để biết thêm thông tin về các trách nhiệm di chuyển dữ liệu, hãy xem [di chuyển dữ liệu](O365-data-migration.md).
...
- Cài đặt các ứng dụng Office dành cho thiết bị di động (chẳng hạn như Outlook for iOS và Android, Word Mobile, Excel Mobile và PowerPoint Mobile) trên thiết bị iOS hoặc Android của bạn. 
- Cấu hình thiết đặt Cập Nhật bằng công cụ triển khai Office 365.
- Chọn và thiết lập một bản cài đặt cục bộ hoặc điện toán đám mây.
...
Cung cấp hướng dẫn về:
- Quản lý bản ghi.
  - Áp dụng quyền cho quản lý bản ghi.
  - Hướng dẫn về dịch các gói tệp và lịch biểu duy trì vào nhãn và chính sách.
  - Tạo nhãn và chính sách duy trì.
  - Thiết lập chính sách xóa.
  - Xem lại các mục cho bố trí.
- Quản lý rủi ro người dùng nội bộ.
  - Bật Nhật ký kiểm tra Office 365.
  - Cấu hình thiết đặt trong quản lý rủi ro người dùng nội bộ.
  - Tạo chính sách rủi ro cơ bản bằng cách sử dụng playbooks dựng sẵn.
  - Đặt cấu hình quyền tuân thủ liên lạc.
  - Tạo các chính sách tuân thủ liên lạc bằng các mẫu tùy chỉnh.
  - Giám sát và xem lại cảnh báo.
- Quản trị thông tin.
  - Áp dụng quyền cho quản trị thông tin.
  - Tạo nhãn duy trì.
  - Phát hành nhãn duy trì (thủ công và tự động).
  - Tạo công việc nhập.
- Khám phá điện tử nâng cao.
  - Dữ liệu không phải là Office 365.
  - Thiết đặt quyền.
  - Tạo trường hợp.
  - Thêm người được gắn tường. 
  - Giữ hợp lệ.
  - Tìm kiếm.
  - Xem lại bộ.
  - Xuất nội dung.
...
- Biết dữ liệu của bạn với nội dung Explorer và hoạt động Explorer.
...
- Thiết lập DNS.  
- Nhóm xác nhận được kích hoạt trên đối tượng thuê Office 365 của bạn.
- Bật hoặc tắt giấy phép người dùng.
- Phân bố máy khách của nhóm.
...
- Cho phép các sự kiện trực tiếp của nhóm. 
...
Cung cấp hướng dẫn về:
- Bật các liên kết an toàn.
- Cho phép phần đính kèm an toàn.
- Bật chính sách chống lừa đảo.
...
Cung cấp hướng dẫn về:
- Tải Outlook lên các thiết bị chạy iOS và Android.
...
- Tải xuống và cài đặt máy khách dự án máy tính để bàn trực tuyến từ cổng thông tin.   
- Cấu hình thiết đặt Cập Nhật bằng công cụ triển khai Office 365 hoặc mẫu chính sách nhóm.
- Thiết lập máy chủ phân phối trên site đơn cho máy khách dự án máy tính để bàn, bao gồm hướng dẫn để tạo tệp configuration.xml cho công cụ triển khai Office 2016. 
- Kết nối máy khách trực tuyến dự án máy tính để bàn dự án trực tuyến.
...
- Cho phép hệ thống điện thoại:
  ...
  - Số nội bộ porting hướng dẫn thông qua giao diện người dùng lên đến 999.
  - Số nội hạt porting hỗ trợ qua 999.
- Bật tính năng phát rộng cuộc họp Skype for Business:
...
\*Để biết thông tin về các trách nhiệm Fasttheo dõi đối với chính phủ Office 365 US, hãy xem mục các [trách nhiệm Fasttheo dõi đối với chính phủ office 365 US](US-Gov-appendix-fasttrack-responsibilities.md).
