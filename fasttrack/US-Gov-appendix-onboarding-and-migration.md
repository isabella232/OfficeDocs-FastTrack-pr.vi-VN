...
Để biết các nhiệm vụ chi tiết cho từng giai đoạn, hãy xem FastTrack Trách nhiệm [đối với Office 365](US-Gov-appendix-fasttrack-responsibilities.md) chính phủ Hoa Kỳ và Trách nhiệm của Bạn đối với Office 365 chính phủ Hoa [Kỳ](US-Gov-appendix-your-responsibilities.md).
...
Bạn có thể nhận trợ giúp [thông qua Trung tâm quản trị Microsoft 365](https://go.microsoft.com/fwlink/?linkid=2032704) hoặc site FastTrack của [bạn.](https://go.microsoft.com/fwlink/?linkid=780698) 
...
Các đối tác cũng có thể nhận trợ [giúp FastTrack thay](https://go.microsoft.com/fwlink/?linkid=780698) mặt cho khách hàng qua site FastTrack nhân danh khách hàng. Cách thực hiện:
1.    Đăng nhập vào [site FastTrack .](https://go.microsoft.com/fwlink/?linkid=780698) 
2.    Chọn **Yêu cầu hỗ trợ Microsoft 365** từ các tác **vụ** nhanh ở đầu trang đích của bạn.
...
Trong giai đoạn này, Trình quản lý FastTrack của bạn sẽ làm việc với bạn trên quá trình lập kế hoạch thành công, hướng dẫn bạn cách thức tài nguyên phù hợp và thực hành tốt nhất để cung cấp hướng dẫn cho bạn để làm cho dịch vụ sẵn dùng cho tổ chức của bạn và thúc đẩy việc sử dụng trên các dịch vụ.
...
Ví dụ Exchange Online, chúng tôi sẽ hướng dẫn bạn từ xa về quy trình để tổ chức của bạn sẵn sàng sử dụng email. Các bước chính xác, tùy thuộc vào môi trường nguồn của bạn và các kế hoạch di chuyển email của bạn, có thể bao gồm việc cung cấp hướng dẫn cho:
...
- Thiết lập dòng email giữa môi trường nhắn tin nguồn của bạn Exchange Online thư (nếu cần).   
- Tiến hành di chuyển thư từ môi trường gửi thư nguồn của bạn Office 365.   
    > [!NOTE]
...
Để biết SharePoint Online và OneDrive for Business, chúng tôi cung cấp hướng dẫn từ xa cho: 
- Thiết lập DNS.   
- Cấu hình cổng tường lửa.   
...
FastTrack Các chuyên gia hướng dẫn về việc di chuyển dữ liệu sang Office 365 cách sử dụng một tổ hợp công cụ và tài liệu, đồng thời thực hiện các tác vụ cấu hình nếu có thể và khả thi.
  
![SharePoint và Skype for Business các bước tiếp thị.](media/O365-Onboarding-Enable-SP.png)
  
## <a name="onedrive-for-business"></a>OneDrive for Business

Ví OneDrive for Business, các bước sẽ phụ thuộc vào việc bạn hiện có đang dùng SharePoint không và nếu có, thì đó là phiên bản nào. 
  
![OneDrive triển OneDrive trong giai đoạn Bật.](media/O365-Onboarding-Enable-ODB.png)
  
## <a name="skype-for-business-online"></a>Skype for Business Online

Để biết Skype for Business Online, chúng tôi cung cấp hướng dẫn từ xa cho: 
- Cấu hình cổng tường lửa.    
- Thiết lập DNS.    
- Tạo tài khoản cho mọi thiết bị hệ thống phòng.    
- Triển khai máy khách Skype for Business Online được hỗ trợ.   
- Thiết lập cấu hình máy chủ tên miền tách giữa môi trường máy chủ Lync 2010, Lync 2013 hoặc Skype for Business 2015 tại chỗ của bạn và Skype for Business Online tại chỗ (nếu áp dụng).
...
![Các bước tiếp diễn trong Lync trong suốt phase_1.](media/O365-Onboarding-Enable-Lync.png)
...
> [!NOTE]
> FastTrack hỗ trợ phạm vi dựa trên sự sẵn sàng của các tính năng trong từng môi trường tương ứng. Để biết danh sách các tính năng hiện có sẵn trong mỗi môi trường, hãy xem Tính <a href="/office365/servicedescriptions/teams-service-description#feature-availability">năng có sẵn.</a>

Ví dụ Microsoft Teams, chúng tôi cung cấp hướng dẫn từ xa cho: 
- Xác nhận các yêu cầu tối thiểu Exchange Online nhóm, SharePoint Nhóm Office 365, Trực tuyến và Azure Active Directory (Azure AD) để hỗ trợ Teams.
- Cấu hình cổng tường lửa.   
- Thiết lập DNS.  
...
- Đánh giá mạng đối với Teams:
    ...
    - Ước tính băng thông.
    - Đặt cấu hình Teams dụng cho máy tính (Teams web app, Teams trên máy tính và Teams dành cho ứng dụng iOS và Android).
 
<br> Nếu có thể, chúng tôi cung cấp hướng dẫn cho: </br>
...
- Hệ thống Điện thoại:
    ...
    - Hướng dẫn Gói Gọi điện (thị<a href="https://go.microsoft.com/fwlink/?linkid=2066478">trường có sẵn</a>):  
        ...
        - Hướng dẫn Định tuyến Trực tiếp:
            - Hướng dẫn thiết lập tổ chức dành cho thiết kế Định tuyến Trực tiếp của các kịch bản do đối tác lưu trữ hoặc các kịch bản do khách hàng triển khai cho tối đa 10 site.
...
- Hướng dẫn chuyển Skype for Business chuyển Teams kế. 
