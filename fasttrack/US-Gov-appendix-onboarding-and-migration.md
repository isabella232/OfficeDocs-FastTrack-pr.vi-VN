...
Các đối tác cũng có thể nhận trợ [giúp FastTrack thay](https://go.microsoft.com/fwlink/?linkid=780698) mặt cho khách hàng trong toàn bộ site. Cách thực hiện:
1.    Đăng nhập vào [site FastTrack của bạn.](https://go.microsoft.com/fwlink/?linkid=780698) 
2.    Chọn **Yêu cầu trợ giúp Microsoft 365** từ các tác **vụ** nhanh ở đầu trang đích của bạn.
...
- Đặt cấu hình cho tính năng SharePoint kết hợp, như tìm kiếm kết hợp, site hỗn hợp, phân loại hỗn hợp, kiểu nội dung, tạo site tự phục vụ kết hợp (chỉ SharePoint Server 2013), công cụ khởi động ứng dụng mở rộng, OneDrive for Business kết hợp và site mạng nội bộ mở rộng.
...
![FastTrack Microsoft Teams trang (Bật pha)](media/42a2d990-4e27-4758-b0cd-0024963c1542.png)
