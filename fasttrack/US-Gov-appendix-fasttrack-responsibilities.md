...
- Kết nối Active Directory tại chỗ của bạn với Azure Active Directory:   
  ...
  - Đối với các môi trường một rừng và nhiều rừng:
      ...
      - Đặt cấu Azure Active Directory cho Sign-On Đơn Liền mạch (SSO), nếu cần (không sẵn dùng trong các gói GCC cao hoặc DoD).
    > [!NOTE]
...
- Trợ giúp từ xa với **Bảo vệ thông tin của Microsoft (xem** Bảo [mật và Tuân thủ).](products-and-capabilities.md#security-and-compliance)
...
- Đặt cấu hình cho Exchange Online Protection năng này (bao gồm Exchange Online tính năng Chống Mối đe dọa Nâng cao nếu có sẵn trong đăng ký của bạn) và xác minh bản ghi MX của bạn trỏ tới Office 365 đối với mọi miền hỗ trợ thư được xác thực.   
- Đặt cấu hình thiết lập hỗn hợp giữa tổ chức Exchange tại chỗ và Office 365 hoặc giữa nhiều tổ chức tại Exchange cơ sở và tổ chức Office 365.   
...
- Cung cấp di chuyển dữ liệu nếu dịch FastTrack chuyển dữ liệu của Trung tâm Được sử dụng và nếu bạn đáp ứng điều kiện tham gia.  
...
- Đặt cấu hình các site SharePoint cơ sở để sử dụng các tính SharePoint hợp Online khác.
...
Cung cấp hướng dẫn về:
- Việc cung Skype for Business danh tính cho liên Office 365.   
...
- Cho Hệ thống Điện thoại dụng (không sẵn dùng trong các GCC cao hoặc DoD):  
...
- Bật Skype for Business Phát Rộng Cuộc họp (không sẵn dùng trong các GCC cao hoặc DoD):  
...
- Microsoft Teams phân phối máy khách của bạn.    
- Các tính năng Pro và quản trị viên CNTT. 
...
- Xác nhận chức Project Online cơ bản bằng cách tạo dự án.
