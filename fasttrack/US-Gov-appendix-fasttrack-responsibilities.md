...
- Thiết lập để SharePoint Online của bạn kiểm soát và chi phối người nhận OneDrive for Business.    
- Triển khai máy khách đồng OneDrive for Business cho máy tính để bàn.   
- Cách cấu SharePoint chuyển hướng OneDrive for Business online kết hợp (SharePoint 2013 và SharePoint 2016).  
...
- Cho Hệ thống Điện thoại dụng (không sẵn dùng trong các GCC cao hoặc DoD):  
  - Cho phép triển Hệ thống Điện thoại các Gói Gọi điện và Cuộc gọi (ở những thị trường có sẵn). 
