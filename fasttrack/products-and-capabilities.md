...
## <a name="services-and-scenarios-supported-by-fasttrack"></a>Dịch vụ và kịch bản được hỗ trợ bởi các FastTrack 

Chủ đề này bao gồm chi tiết về các kịch bản khối lượng công việc được hỗ trợ FastTrack và kỳ vọng môi trường nguồn cần thiết trước khi chúng ta có thể bắt đầu. Dựa trên thiết lập hiện tại của bạn, chúng tôi làm việc với bạn để tạo kế hoạch khắc phục, đưa môi trường nguồn của bạn đến các yêu cầu tối thiểu để triển năng thành công.

FastTrack cung cấp hướng dẫn để giúp bạn trước tiên với các chức năng cốt lõi (phổ biến với tất cả các Dịch vụ Trực tuyến của Microsoft), sau đó triển thị từng dịch vụ đủ điều kiện:
...
> [!NOTE]
> Để biết thông tin về các kỳ vọng về môi trường nguồn Office 365 Chính phủ Hoa Kỳ, hãy xem Kỳ vọng Môi trường [Nguồn Office 365 Chính phủ Hoa Kỳ.](US-Gov-appendix-source-environment-expectations.md)    
...
<li> Chọn và cho phép trải nghiệm xác thực thuận tiện hơn cho người dùng của bạn với xác thực không cần mật khẩu (Fast Identity Online (FIDO)2 hoặc Microsoft Authenticator App).</li>
<li>Cho phép AD FS cho khách hàng với một rừng Active Directory duy nhất và các định danh được đồng bộ hóa với công cụ Azure AD Kết nối động. Yêu cầu phải Windows Server 2012 R2 Active Directory Federation Services 2.0 trở lên.</li>
...
<td>  <strong>Bật mạng </strong>  
  <br>Là một phần của lợi ích FastTrack, chúng tôi khuyên bạn nên tìm cách thực hành tốt nhất để kết nối với dịch vụ đám mây nhằm đảm bảo mức hiệu suất cao nhất của dịch Microsoft 365.  
...
<li>  Cài Ứng dụng Microsoft 365 từ cổng thông Office 365 web bằng Click-to-Run.  </li>
<li>  Cài Office dành cho thiết bị di Outlook Mobile, Word Mobile, Excel Mobile và PowerPoint Mobile) trên các thiết bị chạy iOS hoặc Android.  </li>
...
<li>  Tạo XML cấu hình Office Công cụ Triển khai Đơn giản với Công cụ Tùy chỉnh Office hoặc XML gốc để cấu hình gói triển khai.  </li>
...
<td><ul>
<li>  Phần mềm máy khách trực tuyến phải ở mức tối thiểu như được xác định trong Yêu cầu <a href="https://go.microsoft.com/fwlink/?LinkID=723597">hệ thống cho máy Microsoft 365 và Office.</a>  </li>
</ul></td>
</tr>
<tr class="odd">
...
<li>  Dịch vụ vị trí được bật theo <a href="/Office365/Enterprise/office-365-network-mac-perf-overview">Đề xuất hiệu suất mạng trong Trung Quản trị Microsoft 365 của Bạn (bản xem trước).</a>  </li>
</ul>
<h3 id="section"></h3></td>
</tr>
</tbody>
...
<li>  Cho phép người dùng tạo và quản lý bảo mật đám mây của riêng Office 365 mình bằng tính năng quản lý nhóm tự phục vụ của Azure AD.  </li>
...
<li> Xem lại bảng điều Cloud App Security Cloud Discovery và Cloud Discovery.</li>
...
<li> Triển khai dịch vụ cho môi trường thử nghiệm không sản xuất.</li>
...
<strong>Lưu ý:</strong> Tất cả các phiên bản Windows Server phải được quản lý bởi phiên bản mới nhất của System Center Configuration Manager 2012 (các phiên bản 1012 R2, 1511 hoặc 1602) hoặc Microsoft Endpoint Configuration Manager (phiên bản 2002 trở lên). 
...
<ul>
<li> Onboarding of unmanaged devices not in scope for FastTrack (like Linux).</li>
...
<li> Nội dung đào tạo hoặc hướng dẫn về cấu hình SmartScreen của Bộ bảo vệ bằng cách sử dụng Đối tượng Chính sách Nhóm (GPOs), Bảo mật Windows, Microsoft Edge.</li>
</li>
</ul>
...
<li>  Triển khai cảm biến để chụp và phân tích lưu lượng truy nhập mạng và phân tích các Windows kiện trực tiếp từ bộ điều khiển miền của bạn, bao gồm: </li>
<ul> 
...
<td>  Bộ bảo vệ Microsoft dành cho Office 365 vệ tổ chức của bạn trước các mối đe dọa độc hại do thư email, liên kết (URL) và công cụ cộng tác gây ra. Bộ bảo vệ dành cho Office 365 gồm:
<ul>
...
<li> <a href="/microsoft-365/security/office-365-security/defender-for-office-365?view=o365-worldwide#view-microsoft-defender-for-office-365-reports">Báo cáo</a>: Xem báo cáo trong thời gian thực để giám sát Bộ bảo vệ để Office 365 năng cao trong tổ chức của bạn.</li>
...
<li>  Một tài khoản dịch vụ được tạo cho Active Directory tại cơ sở của bạn đã được đồng bộ hóa với Azure AD. </li>
...
<ul>
<li>  Ứng Outlook cho việc triển khai ứng dụng Microsoft Authenticator và Máy tính của iOS Intune Company Portal với Intune.  </li>
...
<li>  Thiết lập tính năng Cài đặt Bộ bảo Office 365 Microsoft nếu đây là một phần trong dịch vụ đăng ký của bạn. Để biết thêm thông tin, hãy xem <strong>mục Bộ bảo vệ Microsoft Office 365</strong> phần trong bảng này.  </li>
<li>  Thiết lập tính năng ngăn mất dữ liệu (DLP) cho tất cả các tên miền hỗ trợ thư được xác Office 365 như là một phần của dịch vụ đăng ký của bạn. Điều này được thực hiện sau khi bản ghi MX của bạn trỏ Office 365.  </li>
<li>  Thiết lập Mã hóa Thư Office 365 (OME) cho tất cả các miền hỗ trợ thư được xác thực trong Office 365 như một phần của dịch vụ đăng ký của bạn. Điều này được thực hiện sau khi bản ghi MX của bạn trỏ Office 365.  </li>
</ul>
...
<li>  Thiết lập dòng email giữa môi trường nhắn tin nguồn của bạn Exchange Online thư (nếu cần).  </li>
<li>  Tiến hành di chuyển thư từ môi trường gửi thư nguồn của bạn Office 365.  </li>
...
Để biết thông tin về việc sử dụng lợi FastTrack di chuyển dữ liệu sang thiết Office 365, hãy xem <a href="/fasttrack/data-migration">Di chuyển Dữ liệu</a>.   
...
<ul>
<li>  Đặt cấu hình Teams cho ứng dụng (Teams web app, Teams trên máy tính và Teams dành cho ứng dụng iOS và Android).  </li>
</ul>
...
<ul>
<li>  Hướng dẫn thiết lập tổ chức dành cho thiết kế Định tuyến Trực tiếp của các kịch bản do đối tác lưu trữ hoặc các kịch bản do khách hàng triển khai cho tối đa 10 site.  </li>
...
<li>  Hướng dẫn chuyển Skype for Business chuyển Teams kế.  </li>
</ul></td>
<td><ul>
<li>  Danh tính được bật trong Azure AD for Office 365.  </li>
...
<li>  Được bật cho Office 365 Nhóm.  </li>
  ...
  <strong>Lưu ý:</strong> Nếu người dùng chưa được gán và kích hoạt với giấy phép SharePoint Online, họ sẽ không có dung lượng OneDrive for Business lưu trữ Office 365. Tính năng chia sẻ tệp vẫn tiếp tục hoạt động trong Kênh, nhưng người dùng không thể chia sẻ tệp trong Cuộc trò chuyện mà không OneDrive for Business lưu trữ trong Office 365. Teams không hỗ trợ SharePoint tại chỗ.  <br>
  ...
  Các chương trình cài đặt cho ứng Microsoft Teams Windows máy khách trên máy tính Mac và Máy Mac có thể được tải xuống từ <a href="https://go.microsoft.com/fwlink/?linkid=839411">https://go.microsoft.com/fwlink/?linkid=839411</a> .  </td>
</tr>
...
<li>  Bảo mật trên Outlook di động <a href="/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/secure-outlook-for-ios-and-android">(xem mục Bảo mật thiết Outlook cho iOS</a> và Android trong Exchange Online để biết thêm thông tin).  </li>
</ul></td>
<td><ul>
<li>  Danh tính được bật trong Azure AD for Office 365.  </li>
...
<ul>
<li>  Giải quyết các vấn đề về triển khai.  </li>
<li>  Gán giấy phép người dùng cuối bằng cách sử Trung tâm quản trị Microsoft 365 và Windows PowerShell.  </li>
<li>  Cài Project Online trên Máy khách trên máy tính từ Office 365 thông tin Bằng cách sử dụng Click-to-Run.  </li>
<li>  Đặt cấu hình thiết đặt cập nhật bằng cách dùng Office 365 Công cụ Triển khai.  </li>
...
<ul>
<li>  SharePoint cấu hình kết hợp bao gồm cấu hình tìm kiếm hỗn hợp, site, tư cách phân loại, kiểu nội dung, OneDrive for Business, công cụ khởi động ứng dụng mở rộng, site mạng nội bộ mở rộng và tạo site tự phục vụ được kết nối từ môi trường tại chỗ đến môi trường SharePoint Online đích duy nhất.  </li>
</ul>
...
<li>  Để bật SharePoint kết hợp, bạn phải có một trong các môi trường SharePoint Server tại chỗ sau: 2013, 2016 hoặc 2019.  </li>
  ...
  <strong>Lưu ý:</strong> Nâng cấp các môi trường SharePoint tại chỗ cho Máy SharePoint không có phạm vi. Liên hệ với Đối <a href="https://go.microsoft.com/fwlink/?linkid=2080150">tác của Microsoft để</a> được trợ giúp. Để biết thêm thông tin, hãy xem <a href="https://go.microsoft.com/fwlink/?linkid=853548">Mức cập nhật công khai tối thiểu cho các SharePoint hợp khác.</a><em></em>  <br>
...
<td>Phần mềm máy khách trực tuyến phải ở mức tối thiểu như được xác định trong Yêu cầu <a href="https://go.microsoft.com/fwlink/?LinkID=723597">hệ thống cho máy Microsoft 365 và Office.</a></td>
</tr>
</tbody>
</table>
...
<li>  Cung cấp hướng dẫn nâng cấp để hỗ trợ chuyển động triển khai hiện có của bạn. FastTrack đề xuất và cung cấp hướng dẫn nâng cấp tại chỗ lên phiên Windows 10. Hướng dẫn cũng có sẵn để cài Windows đặt hình ảnh gọn gàng và Windows kịch bản triển khai Autopilot.  </li>
<li>  Triển khai Ứng dụng Microsoft 365 sử dụng Trình quản lý Cấu hình như một phần của quá trình triển Windows 10 công việc.   </li>
...
<li>  Đặt cấu hình Windows khởi động Môi trường Thực thi Trước (PXE) cho Môi trường Thực hiện Trước (PXE).  </li>
...
<li>  Phiên bản Bộ quản lý Cấu hình phải được hỗ trợ bởi phiên Windows 10 đích mới. Để biết thêm thông tin, hãy xem bảng hỗ trợ Trình quản lý Cấu <a href="/sccm/core/plan-design/configs/support-for-windows-10">hình tại Hỗ trợ cho Windows 10 trong Trình quản lý Cấu hình.</a>  </li>
</ul>
...
<td><p>Chúng tôi cung cấp hướng dẫn triển khai để triển khai Windows trên Máy tính Ảo (dịch vụ trực quan hóa máy tính và ứng dụng). Windows Màn hình nền Ảo tận dụng lợi thế của trải Windows 10 nhiều phiên và được tối ưu hóa cho Ứng dụng Microsoft 365 Enterprise với khả năng bảo mật và quản lý tích hợp Microsoft 365.</p>
...
<li>Cấu hình loại trừ nội dung và chuyển hướng thư mục cho mọi Ứng dụng Microsoft 365.</li>
</ul></li>
...
<li>Microsoft Endpoint Configuration Manager và thiết Microsoft Endpoint Manager cho máy tính Windows nền Ảo (bao gồm việc vá lỗi và quản lý). </li>
...
<li>  <strong>Microsoft Edge -</strong> Để biết hướng dẫn triển khai, <a href="/DeployEdge/microsoft-edge-channels">xem mục Tổng quan về Microsoft Edge kênh.</a>  </li>
<li>  <strong>Windows Bàn làm việc Ảo</strong> - Để biết thêm thông tin, <a href="/azure/virtual-desktop/overview">hãy xem mục Máy tính Windows Ảo là gì?</a> Windows 10 Enterprise hỏi thường gặp nhiều <a href="/azure/virtual-desktop/windows-10-multisession-faq">phiên.</a>  </li>
<li> Windows đám mây <strong>365 PC</strong> – Để biết thêm thông tin, hãy xem Giới thiệu về một kỷ nguyên mới của điện toán cá nhân kết hợp: PC Windows đám mây <a href="https://www.microsoft.com/microsoft-365/blog/2021/07/14/introducing-a-new-era-of-hybrid-personal-computing-the-windows-365-cloud-pc/">365</a>. </li>
</ul>
...
<li>  Nghiên cứu về các ứng dụng ISV của bên thứ ba để Windows về tính tương thích và tuyên bố hỗ trợ. Để biết thêm thông tin, hãy xem Phân <a href="/sccm/desktop-analytics/overview">tích Màn hình nền</a>.</li>
...
<li> Các ứng dụng đã làm việc vào Office 2010, Office 2013, Office 2016 và Office 2019 cũng hoạt động trên các Ứng dụng Microsoft 365.</li>
</ul>
<strong>Windows đám mây 365 PC</strong>
<ul>
<li> Các ứng dụng đã làm Windows 7, Windows 8.1 và Windows 10 cũng hoạt động trên PC Windows 365 Cloud.</li>
</ul>
...
Các ứng dụng làm việc trên Windows 7, Windows 8.1 và Windows 10 cũng hoạt động trên Windows 10 và Windows 11 trên thiết bị ARM64. 
  ...
  <strong>Lưu ý:</strong> 
<ul>
<li> Tính năng mô phỏng x64 (64 bit) sẵn dùng trong bản xem trước dành cho khách hàng tham gia vào <a href="https://insider.windows.com/">Chương trình Người dùng Windows nội bộ .</a>  </li>
<li>  
...
<li>  
  Khi web không ngừng phát triển, hãy đảm bảo xem lại danh sách đã phát hành các thay đổi ảnh hưởng đến tính tương thích của trang web đã biết <a href="/microsoft-edge/web-platform/site-impacting-changes">Microsoft Edge.</a>  
  </li>
</ul>
...
<li>  
  Ứng dụng 16-bit không được hỗ trợ cho phiên bản 64-bit Windows bàn làm việc ảo.  
  </li>
</ul></td>
</tr>
</tbody>
