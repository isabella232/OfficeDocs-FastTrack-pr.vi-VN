...
> [!NOTE]
> Để biết thông tin về các kỳ vọng môi trường nguồn đối với Chính phủ Hoa Kỳ của Office 365, hãy xem mục Kỳ vọng môi trường nguồn [cho Office 365 dành cho Chính phủ Hoa Kỳ.](/us-gov-appendix-source-environment-expectations) 
...
<td>  Chúng tôi cung cấp hướng dẫn từ xa về triển năng cốt lõi, bao gồm việc cung cấp dịch vụ, tích hợp đối tượng thuê và danh tính. Tài liệu cũng bao gồm các bước cung cấp nền tảng cho các dịch vụ triển trí như Exchange Online, SharePoint Online và Microsoft Teams, bao gồm thảo luận về bảo mật, khả năng kết nối mạng và tuân <a href="/office365/enterprise/office-365-network-connectivity-principles">thủ.</a>   
...
<li>  Dịch vụ vị trí được bật theo <a href="/Office365/Enterprise/office-365-network-mac-perf-overview">Đề xuất hiệu suất mạng trong Trung tâm Quản trị Microsoft 365 (bản xem trước).</a>  </li>
</ul>
<h3 id="section"></h3></td>
</tr>
</tbody>
...
<li> Hỗ <a href=" /fasttrack/us-gov-appendix-overview">GCC-High hoặc GCC-DoD trợ (Office 365 Chính phủ Hoa Kỳ).</a></li>
...
<li> Xem lại bảng điều khiển Bảo mật Ứng dụng Đám mây và Khám phá Điện toán đám mây.</li>
...
<li> Bảo vệ ứng dụng bằng Tính năng Kiểm soát Ứng dụng Truy nhập có Điều kiện trong Cổng thông tin Azure AD và Bảo mật Ứng dụng Đám mây trong Azure AD.</li>
...
<li> Đặt cấu hình Bảo mật Ứng dụng Đám mây để đáp ứng các yêu cầu tuân thủ hoặc quy định cụ thể.</li>
...
<li> Cấu hình SmartScreen của Bộ bảo vệ Microsoft bằng Trình quản lý Điểm cuối của Microsoft.</li>
...
<li> Nội dung đào tạo hoặc hướng dẫn về cấu hình Bộ bảo vệ SmartScreen sử dụng Đối tượng Chính sách Nhóm (GPOS), Bảo mật Windows hoặc Microsoft Edge.</li>
</li>
</ul>
...
<li> Đặt cấu hình Bộ thu thập Sự kiện Windows.</li>
</ul>
<li>  Cấu hình cổng thông tin, bao gồm: </li>
<ul>
...
<li> Giải thích về tùy chọn khắc phục trên tài khoản bị xâm phạm.</li>
</ul>
...
<li> Microsoft .NET Framework 4.7 trở lên.</li>
...
<td>  Bộ bảo vệ Microsoft dành cho Office 365 bảo vệ tổ chức của bạn trước các mối đe dọa độc hại do thư email, liên kết (URL) và công cụ cộng tác gây ra. Bộ bảo vệ dành cho Office 365 bao gồm:
<ul>
...
<li> <a href="/microsoft-365/security/office-365-security/defender-for-office-365?view=o365-worldwide#view-microsoft-defender-for-office-365-reports">Báo cáo</a>: Xem báo cáo trong thời gian thực để giám sát Bộ bảo vệ cho hiệu suất Office 365 trong tổ chức của bạn.</li>
...
<li> Quản lý liên tục, ứng phó với mối đe dọa và khắc phục.</li>
<li> Hỗ <a href=" /fasttrack/us-gov-appendix-overview">GCC-High hoặc GCC-DoD trợ (Office 365 Chính phủ Hoa Kỳ).</a></li>
<li> Thảo luận so sánh Bộ bảo vệ cho Office 365 với các gói đăng ký bảo mật khác.</li>
<li> Triển khai Bộ bảo vệ cho Office 365 làm bằng chứng khái niệm.</li>
<li> Kết nối ứng dụng tùy chỉnh.</li>
<li> Nội dụng đào tạo hoặc hướng dẫn về phòng vệ nâng cao.</li>
<li> Tự động điều tra và khắc phục trong đó có Microsoft Power Automate playbooks.</li>
<li> Quản lý thông tin bảo mật và sự kiện (SIEM) hoặc tích hợp API (bao gồm Azure Sentinel).</li>
...
<td><strong>Bộ bảo vệ Microsoft dành cho Office 365</strong></td>
<td>  Để biết thêm thông tin, xem <strong>mục Bộ bảo vệ Microsoft dành cho Office 365 trong</strong> mục Bảo mật và Tuân <a href="/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.  
</td>
<td></td>
</tr>
...
<li>  Bảo mật Outlook dành cho thiết bị di động <a href="/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/secure-outlook-for-ios-and-android">(xem mục Bảo mật Outlook for iOS và Android trong Exchange Online để</a> biết thêm thông tin).  </li>
</ul></td>
<td><ul>
<li>  Các danh tính được bật trong Azure AD cho Office 365.  </li>
...
<tr class="even">
<td><strong>Azure Active Directory (Azure AD) và Azure AD Premium</strong></td>
<td>  Để biết thêm thông tin, <strong> hãy xem mục Azure Active Directory (Azure AD) và Azure AD Premium trong mục</strong> Bảo mật và Tuân <a href="/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.</td>
<td></td>
</tr>
...
<tr class="even">
<td><strong>Microsoft Intune</strong></td>
<td>  Để biết thêm thông tin, hãy <strong> xem mục Microsoft Intune trong</strong> mục Bảo mật và Tuân <a href="/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.
  </td>
<td>  
...
<li>  Phiên bản Bộ quản lý Cấu hình phải được hỗ trợ bởi phiên bản đích của Windows 10. Để biết thêm thông tin, hãy xem bảng hỗ trợ Trình quản lý <a href="/sccm/core/plan-design/configs/support-for-windows-10">Cấu hình tại Hỗ trợ dành cho Windows 10 trong Trình quản lý Cấu hình.</a>  </li>
</ul>
...
<ul>
<li>Triển khai nhiều phiên Windows 10 Enterprise và các Ứng dụng Microsoft 365 dành cho Doanh nghiệp theo các cách sau:
<ul>
<li>Hình ảnh Azure Marketplace.</li>
<li>Hình ảnh được chia sẻ.</li>
<li>Bộ công cụ Triển khai Office (ODT).</li>
</ul></li>
<li>Cấu hình Ứng dụng Microsoft 365 cho FSLogix trong Máy tính Để bàn Ảo Windows gốc. Đối với FSLogix:
<ul>
<li>Triển khai Tác nhân.</li>
<li>Cấu hình Hồ sơ và bộ chứa Office.</li>
<li>Đặt cấu hình loại trừ nội dung và chuyển hướng thư mục cho Ứng dụng Microsoft 365.</li>
</ul></li>
<li>Triển khai Microsoft Edge.</li>
<li>Triển khai Microsoft Teams với tối ưu hóa.</li>
</ul>

<strong>Sau đây là nằm ngoài phạm vi</strong>
<ul>
<li>Quản lý dự án triển khai cơ sở hạ tầng Máy tính Ảo Windows của khách hàng.</li>
<li>Ảo hóa và triển khai ứng dụng của bên thứ ba.</li>
<li>Tạo hình ảnh tùy chỉnh cho Windows Virtual Desktop.</li>
...
<li>Trình quản lý Cấu hình Microsoft Endpoint và cấu hình Trình quản lý Điểm cuối của Microsoft dành cho Máy tính Ảo chạy Windows (bao gồm vá lỗi và quản lý). </li>
<li>Bộ bảo vệ Microsoft 365 với nhiều phiên chạy Windows 10.</li>
</ul>
Liên hệ với Đối <a href="https://go.microsoft.com/fwlink/?linkid=2080150">tác của Microsoft để</a> được trợ giúp về các dịch vụ này.</td>
<td>Bạn nên có những nội dung sau:
<ul>
<li><a href="/azure/virtual-desktop/overview#requirements">Yêu cầu cấp phép Máy tính Ảo Windows</a>.</li>
<li> Cơ <a href="/azure/virtual-desktop/overview">sở hạ tầng cần thiết để hỗ trợ Windows Virtual Deskstop.</a> </li>
<ul>
<li><a href="/azure/virtual-desktop/store-fslogix-profile"> Dung lượng lưu trữ cho bộ chứa hồ sơ FSLogix trong Windows Virtual Deskstop</a>. </li>
</ul>
...
<li>  <strong>Microsoft Edge -</strong> Để biết hướng dẫn triển khai, <a href="/DeployEdge/microsoft-edge-channels">xem mục Tổng quan về các kênh Microsoft Edge.</a>  </li>
<li>  <strong>Máy tính Để bàn Ảo của</strong> - Windows Để biết thêm thông tin, <a href="/azure/virtual-desktop/overview">hãy xem Mục Máy tính Ảo của Windows là gì?</a> và Câu hỏi thường gặp về nhiều phiên dành <a href="/azure/virtual-desktop/windows-10-multisession-faq">cho Windows 10 Enterprise.</a>  </li>
</ul>
...
<li>  Nghiên cứu các ứng dụng ISV của bên thứ ba cho các tuyên bố hỗ trợ và tương thích với Windows 10. Để biết thêm thông tin, hãy xem Phân <a href="/sccm/desktop-analytics/overview">tích Màn hình nền</a>.</li>
...
<li>  
  Khi web không ngừng phát triển, hãy đảm bảo xem lại danh sách đã phát hành này về các thay đổi ảnh hưởng đến tính tương thích của trang web đã <a href="/microsoft-edge/web-platform/site-impacting-changes">được phát hành cho Microsoft Edge</a>.  
  </li>
</ul>
