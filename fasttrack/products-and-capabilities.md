...
<ul>
<li>Chuẩn bị Định danh Active Directory tại chỗ để đồng bộ hóa với Azure Active Directory (Azure AD) bao gồm cài đặt và đặt cấu hình Azure AD Kết nối (một rừng hoặc nhiều rừng) và cấp phép (bao gồm cấp phép dựa trên nhóm).</li>
...
<li>Cho phép AD FS cho khách hàng với một rừng Active Directory duy nhất và các căn cước được đồng bộ hóa với công cụ Kết nối Azure AD. Điều này yêu Windows 2012 R2 Active Directory Federation Services 2.0 trở lên.</li>
...
<li>  Cài Ứng dụng Microsoft 365 cài đặt từ Office 365 cổng thông tin Bằng Click-to-Run.  </li>
<li>  Cài Office Mobile (như Outlook Mobile, Word Mobile, Excel Mobile và PowerPoint Mobile) trên các thiết bị chạy iOS hoặc Android.  </li>
...
<li>  Deployment using Microsoft Endpoint Configuration Manager, including assistance with the creation of Microsoft Endpoint Configuration Manager packaging.  
  Ngoài ra, nếu bạn có một macro hoặc phần bổ trợ hoạt động với các phiên bản trước của Office và bạn gặp phải sự cố về tính tương thích, chúng tôi cung cấp hướng dẫn khắc phục sự cố tương thích mà không mất thêm phí thông qua chương trình Đảm bảo Ứng dụng. Xem phần <strong>Đảm bảo của</strong> Ứng dụng trong Windows 10 thêm chi tiết. <a href="#windows-10"></a> </li>
</ul></td>
<td><ul>
...
<li>  Dịch vụ vị trí được bật theo <a href="/Office365/Enterprise/office-365-network-mac-perf-overview">Đề xuất hiệu suất mạng trong Trung tâm Quản trị Microsoft 365 kết nối (bản xem trước).</a>  </li>
</ul>
<h3 id="section"></h3></td>
</tr>
</tbody>
...
<ul>
<li>  Đặt cấu hình và bật xác thực mạnh cho định danh của bạn, bao gồm bảo vệ bằng Azure Multi-Factor Authentication (MFA) (chỉ dành cho điện toán đám mây), ứng dụng Microsoft Authenticator và tính năng đăng ký kết hợp cho Azure MFA và tính năng đặt lại mật khẩu tự phục vụ (SSPR).  </li>
...
<td>  
  <tr class="odd">
<td><strong>Khám phá & hồi</strong></td>
<td>  
...
<li>  Thể hiện cách Bộ bảo vệ Microsoft 365 nghiệp tiến hành điều tra tài nguyên, người dùng, thiết bị và hộp thư có thể đã bị xâm phạm thông qua tự động điều tra. </li>
...
<li> Bảo vệ ứng dụng bằng Kiểm soát ứng dụng truy nhập có điều kiện trong Quyền truy nhập có Điều kiện trong Azure AD và Cloud App Security cổng thông tin.</li>
...
<li>  Thực hiện các hướng dẫn về cổng Trung tâm Bảo mật của Bộ bảo vệ Microsoft tin.  </li>
...
<li>  Cấu hình cổng thông tin, bao gồm: </li>
<ul>
<li> Tích hợp Bộ bảo vệ cho Danh tính với Microsoft Cloud App Security ký (Cloud App Security cấp phép không bắt buộc). </li>
...
<li> Mối đe dọa hoặc động từ bắn bắn nâng cao. </li>
<li> Ứng phó sự cố. </li>
</ul>
...
Chúng tôi cung cấp hướng dẫn từ xa cho:  
<ul>
<li>  Bật Két sắt nối kết, Két sắt kèm và chống lừa đảo.  </li>
...
<li> Việc triển khai Bộ bảo vệ Office 365 làm bằng chứng khái niệm.</li>
<li> Kết nối ứng dụng tùy chỉnh.</li>
<li> Nội dụng đào tạo hoặc hướng dẫn về phòng vệ nâng cao.</li>
<li> Điều tra và khắc phục tự động bao gồm các sách Power Automate Microsoft.</li>
<li> Quản lý thông tin bảo mật và sự kiện (SIEM) hoặc tích hợp API (bao gồm Azure Sentinel).</li>
...
<ul>
<li>  Ứng Outlook cho việc triển khai ứng dụng Microsoft Authenticator, cũng như thiết Intune Company Portal của iOS và Android với Intune.  </li>
...
<td>  Ví dụ Exchange Online, chúng tôi hướng dẫn bạn toàn bộ quy trình để tổ chức của bạn sẵn sàng sử dụng email. Các bước chính xác sẽ phụ thuộc vào môi trường nguồn và kế hoạch di chuyển email của bạn.  
  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Thiết lập các Exchange Online Protection dụng (EOP) cho tất cả các tên miền hỗ trợ thư được xác thực trong Office 365.  </li>
...
<li>  Thiết lập tính năng ngăn mất dữ liệu (DLP) cho tất cả các tên miền hỗ trợ thư được xác thực trong Office 365 như là một phần của dịch vụ đăng ký của bạn. Điều này được thực hiện sau khi bản ghi MX của bạn trỏ Office 365.  </li>
<li>  Thiết lập địa Mã hóa Thư Office 365 (OME) cho tất cả các miền hỗ trợ thư được xác thực trong Office 365 như một phần của dịch vụ đăng ký của bạn. Điều này được thực hiện sau khi bản ghi MX của bạn trỏ Office 365.  </li>
</ul>
...
<li>  Thiết lập dòng email giữa môi trường nhắn tin nguồn của bạn Exchange Online (nếu cần).  </li>
<li>  Thực hiện di chuyển thư từ môi trường gửi thư nguồn của bạn Office 365.  </li>
...
Để biết thông tin về việc sử dụng lợi FastTrack di chuyển dữ liệu sang liên Office 365, hãy xem <a href="/fasttrack/data-migration">Di chuyển Dữ liệu</a>.   
...
<li>  Để biết thông tin về Khả năng Đa Địa lý, <a href="https://go.microsoft.com/fwlink/?linkid=872776">hãy xem Mục Khả năng Đa Địa lý trong Exchange Online.</a>  </li>
</ul>
...
<ul>
<li>  Đặt cấu hình Teams cho ứng dụng (Teams web app, Teams desktop app và Teams for iOS và Android app).  </li>
</ul>
...
<li>  Được bật cho Office 365 Nhóm.  </li>
  ...
  <strong>Lưu ý:</strong> Nếu người dùng chưa được gán và kích hoạt với giấy phép SharePoint Online thì họ sẽ không có dung lượng OneDrive for Business lưu trữ Office 365. Tính năng chia sẻ tệp vẫn tiếp tục hoạt động trong Kênh, nhưng người dùng không thể chia sẻ tệp trong Trò chuyện mà không OneDrive for Business lưu trữ trong Office 365. Teams không hỗ trợ SharePoint tại chỗ.  <br>
...
<li>  Đặt cấu hình tài khoản và truy nhập hộp Exchange Online của bạn.  </li>
...
<td>Phần mềm máy khách trực tuyến như Project for Office 365 phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống cho máy <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 và Office.</a></td>
</tr>
<tr class="odd">
...
<li>  Kết nối Project Online máy khách để bàn Project Online Professional hoặc Project Online Premium.  </li>
</ul></td>
<td>Phần mềm máy khách trực tuyến như Project for Office 365 phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống cho máy <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 và Office.</a></td>
</tr>
<tr class="even">
...
<li>  Đặt cấu hình cho SharePoint tính năng kết hợp, chẳng hạn như tìm kiếm kết hợp, site hỗn hợp, phương pháp phân loại hỗn hợp, kiểu nội dung, tạo site tự phục vụ kết hợp (chỉ SharePoint Server 2013), công cụ khởi động ứng dụng mở rộng, OneDrive for Business kết hợp và site mạng nội bộ mở rộng.  </li>
<li>  Phương pháp di chuyển của bạn.  </li>
</ul>
Hướng dẫn bổ sung được cung cấp OneDrive for Business thuộc vào phiên bản SharePoint của bạn, như:
<ul>
<li>  Xác định các tùy chọn tích hợp và xem lại cơ sở hạ tầng mạng và băng thông tại cơ sở cũng như trực tuyến.  </li>
<li>  Cài SharePoint Online 2013 SP1 (nếu có), lập kế hoạch và thực hiện các yêu cầu về đồng bộ và danh tính cũng như xác định máy khách đồng bộ OneDrive for Business của bạn.  </li>
...
<li>  Đề xuất các tùy chọn để bạn đánh giá các ứng Windows 10 dụng của mình.  </li>
...
<li>  Cung cấp hướng dẫn nâng cấp để hỗ trợ chuyển động triển khai hiện có của bạn. FastTrack đề xuất và cung cấp hướng dẫn nâng cấp tại chỗ lên phiên bản Windows 10. Hướng dẫn cũng có sẵn để Windows đặt hình ảnh sạch và áp Windows tình huống triển khai Autopilot.  </li>
...
<li>  Đặt cấu hình Windows khởi động Môi trường Thực thi Trước (PXE) cho Môi trường Thực thi Sẵn có (PXE).  </li>
...
<li>  Phiên bản Trình quản lý Cấu hình phải được hỗ Windows 10 bản đích mới. Để biết thêm thông tin, hãy xem bảng hỗ trợ Trình quản lý <a href="/sccm/core/plan-design/configs/support-for-windows-10">Cấu hình tại Hỗ trợ cho Windows 10 trong Trình quản lý Cấu hình.</a>  </li>
</ul>
...
<tr class="header">
<th>Service</th>
<th>FastTrack tiết hướng dẫn khác</th>
<th>Kỳ vọng môi trường nguồn</th>
</tr>
</thead>
<tbody>
...
<li>Cấu hình Ứng dụng Microsoft 365 cho FSLogix trong màn hình nền Windows nền Ảo riêng. Đối với FSLogix:
<ul>
...
<li>Microsoft Endpoint Configuration Manager và cài Microsoft Endpoint Manager cho máy tính Windows bàn Ảo (bao gồm việc vá lỗi và quản lý). </li>
...
<li>Quy tắc tường lửa để cho phép kết nối Windows Màn hình nền Ảo.
</ul>
...
<ul>
<li>  <strong>Windows 10</strong> và hơn <strong>Windows 11</strong> (bao gồm cả thiết bị ARM64).</li>
...
<li>  <strong>Windows Bàn làm việc Ảo</strong> - Để biết thêm thông tin, hãy xem mục Máy Windows Bàn ảo là <a href="/azure/virtual-desktop/overview">gì?</a> và Xem <a href="/azure/virtual-desktop/windows-10-multisession-faq">Windows 10 Enterprise hỏi thường gặp nhiều phiên.</a>  </li>
...
Các ứng dụng làm việc trên Windows 7, Windows 8.1 và Windows 10 cũng hoạt động trên Windows 10 và Windows 11 trên thiết bị ARM64. 
  ...
  <strong>Lưu ý:</strong> 
<ul>
<li> Tính năng mô phỏng x64 (64 bit) sẵn dùng trong bản xem trước dành cho khách hàng tham gia chương <a href="https://insider.windows.com/">trình người dùng Windows nội bộ</a>.  </li>
<li>  
...
<ul>
<li>  
  Nếu các ứng dụng web hoặc trang web của bạn hoạt động trên Internet Explorer 11, phiên bản được hỗ trợ của Google Chrome hoặc bất kỳ phiên bản Microsoft Edge nào, các ứng dụng hoặc trang web đó cũng sẽ hoạt động với các ứng dụng Microsoft Edge.  
  </li>
<li>  
  Khi web không ngừng phát triển, hãy đảm bảo xem lại danh sách đã phát hành này về các thay đổi ảnh hưởng đến tính tương thích <a href="/microsoft-edge/web-platform/site-impacting-changes">của trang web đã biết Microsoft Edge.</a>  
  </li>
</ul>
...
<strong>Sau đây là nằm ngoài phạm vi </strong>  
<ul>
<li>Project lý hoạt động triển khai công Microsoft Edge khách hàng.</li>
<li>  Hỗ trợ tại chỗ.</li>
