...
<tr class="header">
<th>Service</th>
<th>Chi tiết hướng dẫn FastTrack</th>
...
<li> Xem lại bảng điều Cloud App Security Khám phá Điện toán đám mây.</li>
...
<li> Triển khai Bộ bảo vệ Office 365 làm bằng chứng khái niệm.</li>
<li> Kết nối ứng dụng tùy chỉnh.</li>
<li> Nội dụng đào tạo hoặc hướng dẫn về phòng vệ nâng cao.</li>
<li> Điều tra và khắc phục tự động bao gồm các sách Power Automate Microsoft.</li>
<li> Quản lý thông tin bảo mật và sự kiện (SIEM) hoặc tích hợp API (bao gồm Azure Sentinel).</li>
...
<li>  Triển khai Windows 10 Enterprise và thay Ứng dụng Microsoft 365 cách sử Microsoft Endpoint Configuration Manager hoặc Microsoft 365.  </li>
...
<ul>
<li>Triển khai Windows 10 Enterprise nhiều phiên và Ứng dụng Microsoft 365 cho Doanh nghiệp theo các cách sau:
<ul>
<li>Hình ảnh Azure Marketplace.</li>
<li>Hình ảnh được chia sẻ.</li>
<li>Office Bộ công cụ Triển khai (ODT).</li>
</ul></li>
<li>Đặt cấu Ứng dụng Microsoft 365 cho FSLogix trong màn hình nền Windows nền Ảo riêng. Đối với FSLogix:
<ul>
...
<li>Microsoft Endpoint Configuration Manager và cài Microsoft Endpoint Manager cho máy tính Windows Bàn làm việc Ảo (bao gồm việc vá lỗi và quản lý). </li>
