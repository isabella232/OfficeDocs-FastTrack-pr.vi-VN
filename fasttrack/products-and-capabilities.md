...
FastTrack cung cấp hướng dẫn để giúp bạn trước tiên với các chức năng cốt lõi (phổ biến với tất cả các Dịch vụ Trực tuyến của Microsoft), sau đó triển hành từng dịch vụ đủ điều kiện:
  ...
  - [Máy tính Để bàn Ảo của Windows](#windows-virtual-desktop)
  - [Đảm bảo cho ứng dụng](#app-assure)
  - [Microsoft Edge](#microsoft-edge)

> [!NOTE]
> Để biết thông tin về các kỳ vọng môi trường nguồn đối với Chính phủ Hoa Kỳ của Office 365, hãy xem mục Kỳ vọng môi trường nguồn [cho Office 365 dành cho Chính phủ Hoa Kỳ.](https://docs.microsoft.com/fasttrack/us-gov-appendix-source-environment-expectations) 
...
<ul>
<li>Chuẩn bị định danh Active Directory tại chỗ để đồng bộ hóa với Azure Active Directory (Azure AD), bao gồm cài đặt và đặt cấu hình Azure AD Connect (một rừng hoặc nhiều rừng) và cấp phép (bao gồm cấp phép dựa trên nhóm).</li>
...
<li> Chọn và bật trải nghiệm xác thực thuận tiện hơn cho người dùng của bạn với xác thực không cần mật khẩu (Fast Identity Online (FIDO)2 hoặc Ứng dụng Microsoft Authenticator).</li>
<li>Cho phép AD FS cho khách hàng với một rừng Active Directory duy nhất và các căn cước được đồng bộ hóa với công cụ Azure AD Connect. Điều này yêu cầu Windows Server 2012 R2 Active Directory Federation Services 2.0 trở lên.</li>
...
<li>Cho phép cung cấp người dùng tự động cho các ứng dụng SaaS tích hợp sẵn như được liệt kê trong danh sách hướng dẫn tích hợp Ứng dụng <a href="https://docs.microsoft.com/azure/active-directory/saas-apps/tutorial-list">(giới</a> hạn ở các ứng dụng SaaS bộ sưu tập Azure AD và chỉ cung cấp thư đi).  </li>
</td>

<td>  <strong>Bật mạng </strong>  
  <br>Như một phần của lợi ích FastTrack, chúng tôi khuyên bạn nên thực hành cách tốt nhất để kết nối với dịch vụ đám mây nhằm đảm bảo mức hiệu suất cao nhất của Microsoft 365.  
  
<strong>Rừng Active Directory</strong> Cấp độ rừng chức năng được đặt thành Windows Server 2003 trở đi, với cấu hình rừng sau đây:
<ul>
<li>  Một rừng Active Directory duy nhất.  </li>
<li>  Một rừng tài khoản Active Directory và rừng tài nguyên (Exchange và/hoặc Lync 2010, Lync 2013 hoặc Skype for Business) có liên kết với nhau.  </li>
<li>  Nhiều rừng tài khoản Active Directory và rừng tài nguyên (Exchange và/hoặc Lync 2010, Lync 2013 hoặc Skype for Business) bị giả mạo.  </li>
...
<li>  Nhiều rừng tài khoản Active Directory, mỗi rừng có tổ chức Exchange của riêng mình.  </li>
<li>  Các tác vụ cần thiết cho cấu hình đối tượng thuê và tích hợp với Azure Active Directory, nếu cần thiết.   </li>
</ul>
  <strong>Quan trọng</strong>  <ul>
<li>  Đối với các kịch bản Active Directory nhiều rừng, nếu Lync 2010, Lync 2013 hoặc Skype for Business được triển khai, thì dữ liệu phải được triển khai trong cùng một rừng Active Directory với Exchange.  </li>
<li>  Khi thực hiện nhiều rừng Active Directory với nhiều tổ chức Exchange trong một cấu hình Exchange đa kết hợp, các không gian tên chính của người dùng chung (UPN) giữa các rừng nguồn không được hỗ trợ. Không gian tên SMTP chính giữa các tổ chức Exchange cũng cần được tách biệt. Để biết thêm thông tin, <a href="https://go.microsoft.com/fwlink/?linkid=845444">hãy xem mục Triển khai kết hợp với nhiều rừng Active Directory.</a>  </li>
...
<li>  Gán giấy phép dựa trên thiết bị và người dùng cuối bằng cách sử dụng Trung tâm quản trị Microsoft 365 và Windows PowerShell.  </li>
<li>  Cài đặt Ứng dụng Microsoft 365 từ cổng thông tin Office 365 bằng cách sử dụng Click-to-Run.  </li>
<li>  Cài đặt các ứng dụng Office Mobile (như Outlook Mobile, Word Mobile, Excel Mobile và PowerPoint Mobile) trên thiết bị iOS hoặc Android của bạn.  </li>
<li>  Đặt cấu hình thiết đặt cập nhật bằng Công cụ Triển khai Office 365.  </li>
<li>  Lựa chọn và thiết lập bản cài đặt cục bộ hoặc điện toán đám mây.  </li>
<li>  Tạo XML cấu hình Công cụ Triển khai Office với Công cụ Tùy chỉnh Office hoặc XML gốc để cấu hình gói triển khai.  </li>
<li>  Deployment using Microsoft Endpoint Configuration Manager, including assistance with the creation of Microsoft Endpoint Configuration Manager packaging.  
  Ngoài ra, nếu bạn có một macro hoặc phần bổ trợ hoạt động với các phiên bản trước đó của Office và bạn gặp phải sự cố về tính tương thích, chúng tôi cung cấp hướng dẫn khắc phục sự cố tương thích mà không mất thêm phí thông qua chương trình Đảm bảo ứng dụng. Xem phần <strong>Đảm bảo của</strong> Ứng dụng trong Windows <a href="#windows-10">10 để</a> biết thêm chi tiết. </li>
</ul></td>
<td><ul>
<li>  Phần mềm máy khách trực tuyến phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống đối với <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 và Office.</a>  </li>
</ul></td>
</tr>
<tr class="odd">
<td><strong>Tình trạng mạng</strong></td>
<td>  Chúng tôi cung cấp hướng dẫn từ xa với việc nhận và diễn giải dữ liệu kết nối mạng then chốt từ môi trường của bạn cho thấy cách các site của tổ chức bạn được căn chỉnh như thế nào với các nguyên tắc kết nối <a href="https://docs.microsoft.com/office365/enterprise/office-365-network-connectivity-principles">mạng</a>của Microsoft. Điều này nêu bật điểm số mạng của bạn ảnh hưởng trực tiếp đến tốc độ di chuyển, trải nghiệm người dùng, hiệu suất dịch vụ và độ tin cậy.  
...
<li>  Dịch vụ vị trí được bật theo <a href="https://docs.microsoft.com/Office365/Enterprise/office-365-network-mac-perf-overview">Đề xuất hiệu suất mạng trong Trung tâm Quản trị Microsoft 365 (bản xem trước).</a>  </li>
</ul>
<h3 id="section"></h3></td>
</tr>
</tbody>
...
<ul>
<li>  Đặt cấu hình và bật xác thực mạnh cho định danh của bạn, bao gồm bảo vệ bằng Azure Multi-Factor Authentication (MFA) (chỉ dành cho điện toán đám mây), ứng dụng Microsoft Authenticator và tính năng đăng ký kết hợp cho Azure MFA và đặt lại mật khẩu tự phục vụ (SSPR).  </li>
<li> Triển khai FIDO2 hoặc Ứng dụng Microsoft Authenticator. </li>
<li>  Đối với khách hàng không phải Azure AD Premium, hướng dẫn được cung cấp để bảo mật danh tính của bạn bằng các mặc định bảo mật.  </li>
...
<li>  Quản lý quyền truy nhập cho người quản trị Office 365 của bạn bằng cách sử dụng kiểm soát truy nhập dựa trên vai trò quản trị dựng sẵn (RBAC) và để giảm số lượng tài khoản người quản trị đặc quyền.  </li>
...
<ul>
<li>  
  Cho phép giám sát từ xa cho AD FS, Azure AD Connect và bộ điều khiển miền bằng Azure AD Connect Health.  
  </li>
</ul>
...
<li>  Cho phép người dùng tạo và quản lý bảo mật đám mây của riêng mình hoặc nhóm Office 365 bằng quản lý nhóm tự phục vụ Azure AD.  </li>
...
<td>Active Directory tại chỗ và môi trường của nó đã được chuẩn bị cho Azure AD Premium, bao gồm việc khắc phục các sự cố đã xác định ngăn chặn việc tích hợp với các tính năng Azure AD và Azure AD Premium.</td>
</tr>
<tr class="odd">
...
<strong>Sau đây là nằm ngoài phạm vi </strong> 
<ul>
<li> Tạo và quản lý dòng Power Automate.</li>
...
<li>  Minh họa cách Bộ bảo vệ Microsoft 365 có thể tiến hành điều tra tài nguyên, người dùng, thiết bị và hộp thư có thể đã bị xâm phạm thông qua hoạt động tự động hóa. </li>
...
<td>  Microsoft Cloud App Security là một Nhà môi giới Bảo mật Truy nhập Đám mây (CASB) cung cấp khả năng hiển thị phong phú, kiểm soát việc di chuyển dữ liệu và phân tích tinh vi để xác định và chống lại các mối đe dọa trên mạng từ tất cả các dịch vụ đám mây của Microsoft và bên thứ ba. Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
...
<li> Kết nối các <a href="https://docs.microsoft.com/cloud-app-security/enable-instant-visibility-protection-and-governance-actions-for-your-apps">ứng dụng nổi</a> bật bằng trình kết nối ứng dụng.</li>
<li> Thiết lập Kiểm soát Ứng dụng Truy nhập có Điều kiện trong cổng thông tin Truy nhập có Điều kiện và Bảo mật Ứng dụng Đám mây để áp dụng điều khiển phiên thời gian thực.</li>
<li> Triển khai bảng điều khiển Bảo mật Ứng dụng Đám mây và Khám phá Điện toán đám mây.</li>
...
<li> Hiểu rõ tương quan về sự cố trong cổng thông tin Bộ bảo vệ Microsoft 365.</li>
...
<li> Tự động điều tra và khắc phục trong đó có Microsoft Power Automate playbooks.</li>
...
<li>  Đánh giá phiên bản HĐH và quản lý thiết bị (bao gồm Intune, Trình quản lý Cấu hình Điểm cuối của Microsoft, Đối tượng Chính sách Nhóm (GPOs) và các cấu hình của bên thứ ba) cũng như trạng thái của các dịch vụ AV của Bộ bảo vệ Windows hoặc phần mềm bảo mật điểm cuối khác.  </li>
<li>  Đánh giá trạng thái các dịch vụ Windows AV hoặc phần mềm bảo mật điểm cuối khác của bạn.  </li>
...
<li>  Thực hiện hướng dẫn của cổng thông tin Trung tâm Bảo mật của Bộ bảo vệ Microsoft.  </li>
...
<li>  
  Windows Server Semi-Annual kênh máy chủ (SAC) phiên bản 1803.  
  </li>
<li>  
...
<strong>Lưu ý:</strong> Tất cả các phiên bản Windows Server phải được quản lý bởi phiên bản mới nhất của System Center Configuration Manager 2012 (phiên bản 1012 R2, 1511 hoặc 1602) hoặc Trình quản lý Cấu hình Điểm cuối Microsoft (phiên bản 2002 trở lên). 
...
<li>  Đăng ký hoặc cấu hình cho Chuyên gia Mối đe dọa của Microsoft.  </li>
<li>  Cấu hình hoặc đào tạo xem lại API hoặc các kết nối quản lý sự kiện và quản lý sự kiện (SIEM).  </li>
<li>  Đăng ký hoặc cấu hình Tính năng Chống Mối đe dọa của Microsoft (MTP).  </li>
<li>  Nội dụng đào tạo hoặc hướng dẫn về phòng vệ nâng cao.  </li>
...
<li>  Triển khai cảm biến để chụp và phân tích lưu lượng truy cập mạng và các sự kiện Windows trực tiếp từ bộ kiểm soát miền của bạn, bao gồm: </li>
<ul> 
...
<li>  Không bắt buộc sử dụng Tích hợp Bộ bảo vệ để nhận dạng với Microsoft Cloud App Security (không bắt buộc phải cấp phép Cloud App Security). </li>
...
<li> Windows Server 2019 với KB4487044 (Bản dựng HĐH 17763.316).</li>
</ul>
</ul></td>
</tr>
...
<td>  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Bật liên kết an toàn, tệp đính kèm an toàn và chống lừa đảo qua lại.  </li>
...
<li>  Tạo chính sách Ngăn mất dữ liệu điểm cuối (DLP) cho các thiết bị chạy Windows 10 (được hỗ trợ trong E5).  </li>
<li>  Tạo chính sách DLP cho các cuộc trò chuyện và kênh Microsoft Teams.  </li>
</ul>
...
<li>  Giám sát email khi truyền bằng cách dùng quy tắc dòng thư Exchange Online.  </li>
</ul>

  Chúng tôi cũng cung cấp hướng dẫn nếu bạn muốn áp dụng bảo vệ bằng Dịch vụ Quản trị Quyền của Microsoft Azure (Azure RMS), Mã hóa Thư Office 365 (OME) và ngăn mất dữ liệu (DLP).
...
<li> Tất cả điều kiện tiên quyết cho trình quét Azure Information Protection đều có sẵn. Để biết thêm thông tin, <a href="https://docs.microsoft.com/azure/information-protection/deploy-aip-scanner-prereqs">hãy xem Điều kiện tiên</a>quyết để cài đặt và triển khai máy quét nhãn hợp nhất Azure Information Protection . </li>
...
<ul>
<li> <a href="https://docs.microsoft.com/azure/information-protection/rms-client/clientv2-admin-guide-install">Hướng dẫn Quản trị: Cài đặt máy khách gắn nhãn hợp nhất Azure Information Protection cho người dùng</a>   </li>
<li>  <a href="https://docs.microsoft.com/azure/information-protection/rms-client/mobile-app-faq">Ứng dụng Azure Information Protection dành cho iOS hoặc Android là gì?</a>  </li>
</ul>
...
<strong>Triển khai Outlook dành cho thiết bị di động cho iOS và Android một cách bảo mật</strong> Chúng tôi có thể cung cấp hướng dẫn để giúp bạn triển khai Outlook dành cho thiết bị di động cho iOS và Android một cách an toàn trong tổ chức của bạn để đảm bảo người dùng của bạn đã cài đặt tất cả các ứng dụng bắt buộc.  
  Các bước để triển khai Bảo mật Outlook dành cho thiết bị di động cho iOS và Android với Intune phụ thuộc vào môi trường nguồn của bạn. Nó có thể bao gồm:
<ul>
<li>  Tải xuống các ứng dụng Outlook for iOS và Android, Microsoft Authenticator và Intune Company Portal thông qua Apple App Store hoặc Google Play Store.  </li>
<li>  Cung cấp hướng dẫn thiết lập:
<ul>
<li>  Triển khai các ứng dụng Outlook for iOS và Android, Microsoft Authenticator và Intune Company Portal với Intune.  </li>
...
<td>  Đối với Exchange Online, chúng tôi hướng dẫn bạn toàn bộ quy trình để tổ chức của bạn sẵn sàng sử dụng email. Các bước chính xác sẽ phụ thuộc vào môi trường nguồn và kế hoạch di chuyển email của bạn.  
  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Thiết lập các tính năng Exchange Online Protection (EOP) cho tất cả các tên miền hỗ trợ thư được xác thực trong Office 365.  </li>
<li>  Trỏ bản ghi trao đổi thư (MX) của bạn đến Office 365.  </li>
<li>  Thiết lập tính năng Bộ bảo vệ Microsoft dành cho Office 365 nếu đây là một phần trong dịch vụ đăng ký của bạn. Để biết thêm thông tin, hãy <strong>xem phần Bộ bảo vệ Microsoft dành cho Office 365</strong> trong bảng này.  </li>
<li>  Thiết lập tính năng ngăn mất dữ liệu (DLP) cho tất cả các tên miền hỗ trợ thư được xác thực trong Office 365 như là một phần của dịch vụ thuê bao của bạn. Điều này được thực hiện sau khi bản ghi MX của bạn trỏ tới Office 365.  </li>
<li>  Thiết lập Mã hóa Thư Office 365 (OME) cho tất cả các miền hỗ trợ thư được xác thực trong Office 365 như là một phần của dịch vụ đăng ký của bạn. Điều này được thực hiện sau khi bản ghi MX của bạn trỏ tới Office 365.  </li>
</ul>
...
<li>  Thiết lập dòng email giữa môi trường nhắn tin nguồn của bạn và Exchange Online (nếu cần).  </li>
<li>  Thực hiện di chuyển thư từ môi trường gửi thư nguồn của bạn sang Office 365.  </li>
<li>  Cấu hình máy khách hộp thư (Outlook cho Windows, Outlook trên web và Outlook cho iOS và Android).  </li>
</ul>
  <strong>Di chuyển dữ liệu</strong>  <br>
Để biết thông tin về việc sử dụng lợi ích FastTrack cho việc di chuyển dữ liệu sang Office 365, hãy xem <a href="https://docs.microsoft.com/fasttrack/data-migration">di chuyển dữ liệu</a>.   
...
<li>  Để biết thông tin về Khả năng Đa Địa lý, <a href="https://go.microsoft.com/fwlink/?linkid=872776">hãy xem Multi-Geo Capabilities trong Exchange Online</a>.  </li>
</ul>
Phần mềm máy khách trực tuyến như Project for Office 365, Outlook for Windows, Outlook for iOS và Android, máy khách đồng bộ OneDrive for Business, Power BI trên Máy tính bàn và Skype for Business phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống cho <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 Office.</a>  </td>
</tr>

<td><strong>Bộ bảo vệ Microsoft dành cho Office 365</strong></td>
<td>  Để biết thêm thông tin, xem <strong>mục Bộ bảo vệ Microsoft dành cho Office 365 trong</strong> mục Bảo mật và Tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.  
</td>
<td></td>
</tr>
...
<tr class="even">
<td><strong>Quản trị Thông tin Microsoft</strong></td>
<td>  Để biết thêm thông tin, hãy xem <strong> mục Quản trị Thông tin của Microsoft</strong> trong bảo mật và tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>. 
...
<td><strong>Microsoft Information Protection</strong></td>
<td>  
Để biết thêm thông tin, hãy xem <strong>mục Bảo vệ Thông tin của Microsoft </strong> trong bảo mật và tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.
...
<td>  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Xác nhận các yêu cầu tối thiểu trong Exchange Online, SharePoint Online, Nhóm Office 365 và Azure AD để hỗ trợ Teams.  </li>
<li>  Cấu hình cổng tường lửa.  </li>
<li>  Thiết lập DNS.  </li>
<li>  Xác nhận Teams được bật trên đối tượng thuê Office 365 của bạn.  </li>
...
<ul>
<li>  Đặt cấu hình chính sách ứng dụng Teams (ứng dụng Teams trên web, ứng dụng Teams trên máy tính và Teams cho ứng dụng iOS và Android).  </li>
</ul>
Nếu có thể, chúng tôi cũng cung cấp hướng dẫn cho:
<ul>
<li>  Thiết bị Phòng họp của Microsoft Teams:  </li>
<ul>
<li>  Việc tạo tài khoản trực tuyến cần thiết cho các thiết bị điện thoại và phòng hội thảo được hỗ trợ được liệt kê trong <a href="https://go.microsoft.com/fwlink/?linkid=2066478">danh mục thiết bị Teams.</a>  </li>
<li>  Trợ giúp từ xa với cấu hình phía dịch vụ của các thiết bị Phòng microsoft Teams được chứng nhận.  </li>
...
<li>  Bật các sự kiện trực tiếp trong Teams.  </li>
<li>  Thiết lập và tích hợp tổ chức vào Microsoft Stream.  </li>
<li>  Hướng dẫn chuyển đổi Skype for Business sang Teams.  </li>
</ul></td>
<td><ul>
<li>  Các danh tính được bật trong Azure AD cho Office 365.  </li>
<li>  Người dùng được kích hoạt cho SharePoint Online.  </li>
<li>  Hộp thư Exchange hiện diện (trực tuyến và tại chỗ trong cấu hình Exchange kết hợp).  </li>
<li>  Được bật cho Nhóm Office 365.  </li>
</ul>
  <strong>Lưu ý:</strong> Nếu người dùng chưa được gán và kích hoạt với giấy phép SharePoint Online, họ sẽ không có dung lượng lưu trữ OneDrive for Business trong Office 365. Tính năng chia sẻ tệp vẫn tiếp tục hoạt động trong Kênh nhưng người dùng không thể chia sẻ tệp trong Cuộc trò chuyện mà không có dung lượng lưu trữ OneDrive for Business trong Office 365. Teams không hỗ trợ SharePoint tại chỗ.  <br>
  <strong>Lưu ý:</strong> Trạng thái lý tưởng là để tất cả người dùng có hộp thư của họ ở nhà trên Exchange Online. Người dùng có hộp thư tại cơ sở phải được đồng bộ hóa danh tính của họ với thư mục Office 365 thông qua Azure AD Connect. Đối với các khách hàng Exchange hỗn hợp này, nếu hộp thư của người dùng là tại chỗ, người dùng không thể thêm hoặc cấu hình Bộ nối.  
  Có thể tải xuống các chương trình cài đặt cho máy khách microsoft Teams trên máy tính chạy Windows và Mac từ <a href="https://go.microsoft.com/fwlink/?linkid=839411">https://go.microsoft.com/fwlink/?linkid=839411</a> .  </td>
</tr>

<tr class="even">
<td><strong>Outlook for iOS và Outlook for Android</strong></td>
<td>  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Tải xuống Outlook for iOS và Android từ Apple App Store và Google Play.  </li>
<li>  Đặt cấu hình tài khoản và truy nhập hộp thư Exchange Online.  </li>
<li>  Bảo mật Outlook dành cho thiết bị di động <a href="https://docs.microsoft.com/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/secure-outlook-for-ios-and-android">(xem mục Bảo mật Outlook for iOS và Android trong Exchange Online để</a> biết thêm thông tin).  </li>
</ul></td>
<td><ul>
<li>  Các danh tính được bật trong Azure AD cho Office 365.  </li>
<li>  Exchange Online được đặt cấu hình và giấy phép đã gán.  </li>
</ul></td>
</tr>
<tr class="odd">
...
<li>  Triển khai ứng dụng Power BI trên Máy tính bàn.  </li>
</ul></td>
<td>Phần mềm máy khách trực tuyến như Power BI Desktop phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống <a href="https://go.microsoft.com/fwlink/?LinkID=723597">cho Microsoft 365 và Office.</a></td>
</tr>
<tr class="even">
<td><strong>Project Online</strong></td>
<td>  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Xác nhận chức năng SharePoint cơ bản mà Project Online tin tưởng.  </li>
...
<td>Phần mềm máy khách trực tuyến như Project for Office 365 phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống cho <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 và Office.</a></td>
</tr>
<tr class="odd">
...
<li>  Cài đặt Máy khách Project Online trên Máy tính từ cổng thông tin Office 365 bằng Click-to-Run.  </li>
<li>  Đặt cấu hình thiết đặt cập nhật bằng Công cụ Triển khai Office 365.  </li>
...
<li>  Kết nối Máy khách Trên máy tính của Project Online với Project Online Professional hoặc Project Online Premium.  </li>
</ul></td>
<td>Phần mềm máy khách trực tuyến như Project for Office 365 phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống cho <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 và Office.</a></td>
</tr>
<tr class="even">
...
<li>Cho phép tạo site cho người quản trị SharePoint Online của bạn.</li>
...
<li>  Đặt cấu hình các tính năng kết hợp của SharePoint, như tìm kiếm kết hợp, site hỗn hợp, phương pháp phân loại hỗn hợp, kiểu nội dung, tạo site tự phục vụ kết hợp (chỉ SharePoint Server 2013), công cụ khởi động ứng dụng mở rộng, OneDrive for Business kết hợp và các site mạng nội bộ mở rộng.  </li>
<li>  Phương pháp di chuyển của bạn.  </li>
</ul>
Hướng dẫn bổ sung được cung cấp cho OneDrive for Business tùy thuộc vào phiên bản SharePoint của bạn, như:
<ul>
<li>  Xác định các tùy chọn tích hợp và xem lại cơ sở hạ tầng mạng và băng thông tại cơ sở cũng như trực tuyến.  </li>
<li>  Cài đặt SharePoint Online 2013 SP1 (nếu có), lập kế hoạch và thực hiện các yêu cầu về đồng bộ và danh tính cũng như xác định máy khách đồng bộ OneDrive for Business của bạn.  </li>
...
<li>  Triển khai đồng bộ máy khách OneDrive for Business.  </li>
</ul>
  <strong>Di chuyển dữ liệu</strong>  <br>
Để biết thông tin về việc sử dụng lợi ích FastTrack cho việc di chuyển dữ liệu sang Office 365, hãy xem <a href="https://docs.microsoft.com/fasttrack/data-migration">di chuyển dữ liệu</a>.
</ul></td>
...
<ul>
<li>  Cấu hình SharePoint kết hợp bao gồm cấu hình tìm kiếm kết hợp, site, phân loại, kiểu nội dung, OneDrive for Business, công cụ khởi động ứng dụng mở rộng, site mạng nội bộ mở rộng và tạo site tự phục vụ được kết nối từ môi trường SharePoint Online tại chỗ đến môi trường SharePoint Online đích duy nhất.  </li>
</ul>
  <strong>Lưu ý:</strong> Tính năng tạo site tự phục vụ không nằm trong phạm vi các máy chủ tại chỗ chạy SharePoint 2013.  
<ul>
<li>  Để bật kết hợp SharePoint, bạn phải có một trong các môi trường SharePoint Server tại chỗ sau: 2013, 2016 hoặc 2019.  </li>
</ul>
  <strong>Lưu ý:</strong> Nâng cấp môi trường SharePoint tại chỗ lên SharePoint Server không nằm trong phạm vi. Liên hệ với Đối <a href="https://go.microsoft.com/fwlink/?linkid=2080150">tác của Microsoft để</a> được trợ giúp. Để biết thêm thông tin, hãy xem <a href="https://go.microsoft.com/fwlink/?linkid=853548">mức cập nhật công khai tối thiểu cho các tính năng SharePoint hỗn</a><em>hợp.</em>  <br>
  <strong>Lưu ý:</strong> Để biết thông tin về Khả năng Đa Địa lý, <a href="https://go.microsoft.com/fwlink/?linkid=831056">hãy xem mục Multi-Geo Capabilities trong OneDrive và SharePoint Online trong Office 365.</a><em></em>  </td>
</tr>
<tr class="even">
<td><strong>Yammer Enterprise</strong></td>
<td>
Chúng tôi cung cấp hướng dẫn từ xa để bật dịch vụ Yammer Enterprise.  
</td>
<td>Phần mềm máy khách trực tuyến phải ở mức tối thiểu như được xác định trong Yêu cầu hệ thống đối với <a href="https://go.microsoft.com/fwlink/?LinkID=723597">Microsoft 365 và Office.</a></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><strong>Azure Active Directory (Azure AD) và Azure AD Premium</strong></td>
<td>  Để biết thêm thông tin, <strong> hãy xem mục Azure Active Directory (Azure AD) và Azure AD Premium trong mục</strong> Bảo mật và Tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.</td>
<td></td>
</tr>
<tr class="odd">
<td><strong>Azure Information Protection </strong></td>
<td>  Để biết thêm thông tin về Azure Information Protection, hãy xem <strong>mục Bảo vệ Thông tin của Microsoft</strong> trong Bảo mật và Tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance"> thủ.  </td>
<td>  
...
<tr class="even">
<td><strong>Microsoft Intune</strong></td>
<td>  Để biết thêm thông tin, hãy <strong> xem mục Microsoft Intune trong</strong> mục Bảo mật và Tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.
  </td>
<td>  
...
<td>  Chúng tôi cung cấp hướng dẫn nâng cấp từ Windows 7 Professional và Windows 8.1 Professional lên Windows 10 Enterprise.  
  Chúng tôi cung cấp hướng dẫn từ xa cho:
<ul>
<li>  Hiểu ý định của bạn trong Windows 10.  </li>
<li>  Đánh giá môi trường nguồn và yêu cầu (đảm bảo rằng Trình quản lý Cấu hình Điểm cuối của Microsoft được nâng cấp lên mức bắt buộc để hỗ trợ triển khai Windows 10).  </li>
<li>  Triển khai các Ứng dụng Windows 10 Enterprise và Microsoft 365 bằng Trình quản lý Cấu hình Điểm cuối của Microsoft hoặc Microsoft 365.  </li>
<li>  Đề xuất các tùy chọn để bạn đánh giá ứng dụng Windows 10.  </li>
<li>  Cho phép sử dụng Phân tích màn hình nền và hướng dẫn thông qua việc tạo kế hoạch triển khai Phân tích Màn hình nền.  </li>
<li>  Đánh giá tính tương thích của Ứng dụng Microsoft 365 bằng cách tận dụng bảng điều khiển tính sẵn sàng của Office 365 trong Trình quản lý Cấu hình hoặc Bộ công cụ Sẵn sàng độc lập dành cho Office, đồng thời hỗ trợ triển khai Ứng dụng Microsoft 365.  </li>
...
<li>  Cung cấp hướng dẫn nâng cấp cho các thiết bị hiện có của bạn lên Windows 10 Enterprise nếu chúng đáp ứng các yêu cầu về phần cứng thiết bị cần thiết.  </li>
<li>  Cung cấp hướng dẫn nâng cấp để hỗ trợ chuyển động triển khai hiện có của bạn. FastTrack đề xuất và cung cấp hướng dẫn nâng cấp tại chỗ lên Windows 10. Hướng dẫn cũng có sẵn cho các kịch bản cài đặt hình ảnh sạch của Windows và các kịch bản triển khai Windows Autopilot.  </li>
<li>  Triển khai Ứng dụng Microsoft 365 bằng Trình quản lý Cấu hình như một phần của việc triển khai Windows 10.   </li>
<li>  Hướng dẫn này giúp tổ chức của bạn luôn cập nhật các Ứng dụng Windows 10 Enterprise và Microsoft 365 bằng cách sử dụng môi trường Trình quản lý Cấu hình hiện có của bạn hoặc Microsoft 365.  </li>
</ul>
  
<strong>Sau đây là nằm ngoài phạm vi </strong>  
<ul>
<li>  Nâng cấp Trình quản lý Cấu hình thành Nhánh Hiện tại.  </li>
<li>  Tạo hình ảnh tùy chỉnh để triển khai Windows 10.  </li>
<li>  Tạo và hỗ trợ tập lệnh triển khai cho triển khai Windows 10.  </li>
<li>  Converting a Windows 10 system from BIOS to Unified Extensible Firmware Interface (UEFI).  </li>
<li>  Bật các tính năng bảo mật của Windows 10.  </li>
<li>  Đặt cấu hình cho việc khởi động Môi trường Thực thi Trước (PXE) cho Windows Deployment Services (WDS).  </li>
...
<li>  Phiên bản Bộ quản lý Cấu hình phải được hỗ trợ bởi phiên bản đích của Windows 10. Để biết thêm thông tin, hãy xem bảng hỗ trợ Trình quản lý <a href="https://docs.microsoft.com/sccm/core/plan-design/configs/support-for-windows-10">Cấu hình tại Hỗ trợ dành cho Windows 10 trong Trình quản lý Cấu hình.</a>  </li>
</ul>

<tr class="odd">
<td><strong>Bộ bảo vệ Microsoft dành cho Điểm cuối</strong></td>
<td>  Để biết thêm thông tin, xem <strong> mục Bộ bảo vệ Microsoft dành cho điểm cuối trong</strong> mục Bảo mật và Tuân <a href="https://docs.microsoft.com/fasttrack/products-and-capabilities#security-and-compliance">thủ</a>.</td>
<td></td>

</tbody>
</table>

## <a name="windows-virtual-desktop"></a>Máy tính Để bàn Ảo của Windows
...
<tbody>
<tr class="odd">
<td><strong>Máy tính Để bàn Ảo của Windows</strong></td>
<td><p>Chúng tôi cung cấp hướng dẫn triển khai cho Windows Virtual Desktop (một dịch vụ ảo hóa máy tính và ứng dụng). Máy tính Để bàn Ảo Windows tận dụng lợi thế của trải nghiệm nhiều phiên chạy Windows 10 và được tối ưu hóa cho Ứng dụng Microsoft 365 dành cho Doanh nghiệp với khả năng bảo mật và quản lý tích hợp dành cho Microsoft 365.</p>
<p>Chúng tôi cung cấp hướng dẫn từ xa cho:</p>
<ul>
<li>Triển khai môi trường Máy tính Ảo Windows với nhiều phiên dành cho Windows 10 Enterprise và Ứng dụng Microsoft 365 dành cho Doanh nghiệp bằng cách sử dụng các tính năng sau:
<ul>
...
<li>Kết nối bằng cách dùng máy khách Màn hình Nền Ảo Windows.</li>
</ul>

<strong>Sau đây là nằm ngoài phạm vi</strong>
<ul>
<li>Quản lý dự án cho triển khai Windows Virtual Desktop của khách hàng.</li>
...
<ul>
<li><a href="https://docs.microsoft.com/azure/virtual-desktop/overview#requirements">Yêu cầu cấp phép Máy tính Ảo Windows</a>.</li>
...
<li>Quy tắc tường lửa để cho phép kết nối với Máy tính Ảo Windows.
</ul>
Để biết thêm thông tin, hãy xem Máy <a href="https://docs.microsoft.com/azure/virtual-desktop/overview#supported-remote-desktop-clients"> khách Từ xa được hỗ trợ</a>.
</ul>
...
<li>Active Directory với Azure AD Connect tại chỗ qua VPN hoặc ExpressRoute.</li>
...
<td>  Đảm bảo Ứng dụng là một dịch vụ được thiết kế để giải quyết các sự cố về tính tương thích của ứng dụng Windows 10 và Ứng dụng Microsoft 365. Khi bạn yêu cầu dịch vụ Đảm bảo ứng dụng, chúng tôi sẽ làm việc với bạn để giải quyết các sự cố ứng dụng hợp lệ mà không mất thêm chi phí cho bạn với đăng ký đủ điều kiện. Chúng tôi cũng cung cấp hướng dẫn cho những khách hàng gặp phải sự cố về tương thích khi triển khai Windows Virtual Desktop và Microsoft Edge và thực hiện mọi nỗ lực hợp lý để giải quyết các vấn đề liên quan đến tính tương thích. Chúng tôi cung cấp trợ giúp khắc phục cho các ứng dụng được triển khai trên các sản phẩm Microsoft sau:
<ul>
<li>  <strong>Windows 10 </strong> (bao gồm các thiết bị ARM64)</li>
<li> <strong>Ứng dụng Microsoft 365</strong>  </li>
<li>  <strong>Microsoft Edge -</strong> Để biết hướng dẫn triển khai, <a href="https://docs.microsoft.com/DeployEdge/microsoft-edge-channels">xem mục Tổng quan về các kênh Microsoft Edge.</a>  </li>
<li>  <strong>Máy tính Để bàn Ảo của</strong> - Windows Để biết thêm thông tin, <a href="https://docs.microsoft.com/azure/virtual-desktop/overview">hãy xem Mục Máy tính Ảo của Windows là gì?</a> và Câu hỏi thường gặp về nhiều phiên dành <a href="https://docs.microsoft.com/azure/virtual-desktop/windows-10-multisession-faq">cho Windows 10 Enterprise.</a>  </li>
</ul>

<strong>Sau đây là nằm ngoài phạm vi </strong>  
<ul>
<li>  Kiểm kê và kiểm tra ứng dụng để xác định xem ứng dụng nào và không hoạt động trên Ứng dụng Windows 10 và Microsoft 365. Để biết thêm hướng dẫn về quy trình này, hãy truy nhập Trung tâm <a href="https://go.microsoft.com/fwlink/?linkid=2080140">Triển khai Máy tính</a>để bàn . Nếu bạn quan tâm đến hoạt động đánh giá tính sẵn sàng của nâng cấp chuyên sâu, hãy hoàn thành biểu mẫu Yêu cầu Khách hàng <a href="https://go.microsoft.com/fwlink/?linkid=2053818">đối với Đánh giá Máy tính Hiện</a> đại.</li>
<li>  Nghiên cứu các ứng dụng ISV của bên thứ ba cho các tuyên bố hỗ trợ và tương thích với Windows 10. Để biết thêm thông tin, hãy xem Phân <a href="https://docs.microsoft.com/sccm/desktop-analytics/overview">tích Màn hình nền</a>.</li>
<li>Dịch vụ chỉ đóng gói ứng dụng. Tuy nhiên, các ứng dụng gói Đảm bảo cho nhóm Mà chúng tôi đã khắc phục cho Windows 10 để đảm bảo chúng có thể được triển khai trong môi trường của khách hàng.</li>
</ul>

<strong>Trách nhiệm của khách hàng bao gồm</strong>  
<ul>
<li>  Tạo thư mục ứng dụng.</li>
<li>  Xác thực các ứng dụng đó trên Ứng dụng Windows 10 và Microsoft 365.</li>
</ul>
...
<ul>
<li>  
  Các ứng dụng làm việc trên Windows 7, Windows 8.1, Office 2010 và Office 2013 cũng hoạt động trên các Ứng dụng Windows 10 và Microsoft 365.  
  </li>
</ul>
<strong>Windows 10 trên ARM</strong>
<ul>
<li>  
Ứng dụng hoạt động trên Windows 7, Office 2010 hoặc phiên bản mới hơn cũng hoạt động trên Ứng dụng Windows 10 và Microsoft 365 trên thiết bị ARM64. 
  </li>
</ul>
  <strong>Lưu ý:</strong> 
<ul>
<li> Tính năng mô phỏng x64 (64 bit) có sẵn trong bản xem trước dành cho khách hàng tham gia vào Chương <a href="https://insider.windows.com/">trình Người dùng Nội bộ Windows.</a>  </li>
<li>  
 Đối với khách hàng không phải là Người dùng nội bộ Windows trên Windows 10 phiên bản 2004 (trở lên), ARM64 Photoshop được hỗ trợ sử dụng Gói Tương thích OpenCL và <a href="https://www.microsoft.com/p/opencl-and-opengl-compatibility-pack/9nqpsl29bfff?rtc=1&activetab=pivot:overviewtab">OpenGL.</a> 
  </li>
<li>  
  Khách hàng trong Chương trình Người dùng Nội bộ Windows có thể tải xuống phiên bản Người dùng nội bộ của Gói Tương thích OpenCL và OpenGL để sử dụng với các ứng dụng bổ sung.    
  </li>
</ul>
<strong>Microsoft Edge</strong>
<ul>
<li>  
  Nếu các ứng dụng web hoặc trang web của bạn hoạt động trên Internet Explorer 11, phiên bản được hỗ trợ của Google Chrome hoặc bất kỳ phiên bản Microsoft Edge nào, các ứng dụng hoặc trang web đó cũng sẽ hoạt động với Microsoft Edge.  
  </li>
<li>  
  Khi web không ngừng phát triển, hãy đảm bảo xem lại danh sách đã phát hành này về các thay đổi ảnh hưởng đến tính tương thích của trang web đã <a href="https://docs.microsoft.com/microsoft-edge/web-platform/site-impacting-changes">được phát hành cho Microsoft Edge</a>.  
  </li>
</ul>
  <strong>Máy tính Để bàn Ảo của Windows </strong>  
<ul>
<li>  
  Các ứng dụng được ảo hóa chạy trên Máy chủ Phiên Làm việc Từ xa của Windows Server (RDSH) cũng chạy trên nhiều phiên làm việc của Windows 10 Enterprise như là một phần của Windows Virtual Desktop.  
  </li>
<li>  
  Các ứng dụng chạy trên bất kỳ môi trường cơ sở hạ tầng máy tính để bàn ảo (VDI) nào của Windows 7 hoặc Windows 10 cũng chạy trên Windows 7 Enterprise và Windows 10 Enterprise như là một phần của Windows Virtual Desktop.  
  </li>
<li>  
  Các ứng dụng chạy trên các thiết bị máy khách Windows 7 hoặc Windows 10 cũng chạy trên Windows 7 Enterprise và Windows 10 Enterprise như là một phần của Windows Virtual Desktop.  
  </li>
</ul>
  <strong>Lưu ý:</strong> Các loại trừ và giới hạn về tính tương thích nhiều phiên của Windows 10 Enterprise bao gồm:
<ul>
<li>  
...
<li>  
  Các ứng dụng 16-bit không được hỗ trợ cho Máy tính Để bàn Ảo Windows 64-bit.  
  </li>
</ul></td>
</tr>
</tbody>
...
<td>
Chúng tôi cung cấp hướng dẫn triển khai và tiếp nhận từ xa cũng như hỗ trợ tương thích cho: <ul> <li>Triển khai Microsoft Edge trên Windows 10 với Trình quản lý Điểm cuối của Microsoft (Trình quản lý Cấu hình Điểm cuối của Microsoft hoặc Intune).  </li>
...
<strong>Sau đây là nằm ngoài phạm vi </strong>  
<ul>
<li>Quản lý dự án cho triển khai Microsoft Edge của khách hàng.</li>
<li>  Hỗ trợ tại chỗ.</li>
